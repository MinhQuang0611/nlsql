  ...
  $driver.setSteps([
    ...
    },
    {
      ...
      popover: {
        ...
        description: renderToString(
          <>
            Bạn có thể chỉnh sửa alias (tên thay thế) và mô tả của các model và
            cột.
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
...
const LanguageSwitcher = (props: { defaultValue: ProjectLanguage }) => {
  ...
  return (
    <>
      <label className="d-block mb-2">Ngôn ngữ dự án</label>
      <Select
        showSearch
        style={{ width: '100%' }}
  ...
  $driver.setSteps([
    {
      popover: {
        ...
        description: renderToString(
          <>
            Chọn ngôn ngữ bạn muốn sử dụng. Sau khi thiết lập, AI sẽ trả lời
            bằng ngôn ngữ bạn đã chọn.
            <div className="my-3">
              <div id="projectLanguageContainer" />
            </div>
            Bạn có thể vào cài đặt dự án để thay đổi nếu muốn.
          </>,
        ),
        onPopoverRender: (popoverDom: DriverPopoverDOM) => {
