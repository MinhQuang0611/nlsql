            ...
            <div className="mt-2 mb-3" data-guideid="text-answer-preview-data">
              {hasPreviewData && (
                <Text type="secondary" className="text-sm">
                  Do giới hạn của cửa sổ ngữ cảnh, chúng tôi trích xuất tối đa
                  500 dòng kết quả để tạo câu trả lời.
                </Text>
              )}
              <PreviewData
          ...
          <>
            {!isStreaming && (
              <Alert
                message={
                  <>
                    Nhấn <b>Xem SQL</b> để xem logic truy vấn từng bước
                    <br />
                    và xác minh tại sao dữ liệu không khả dụng.
                  </>
                }
                type="info"
              />
