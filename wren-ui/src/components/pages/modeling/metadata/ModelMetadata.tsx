    ...
    <>
      <Row className="mb-6">
        <Col span={12} data-testid="metadata__name">
          <Typography.Text className="d-block gray-7 mb-2">Tên</Typography.Text>
      ...
      <div className="mb-6" data-testid="metadata__description">
        <Typography.Text className="d-block gray-7 mb-2">Mô tả</Typography.Text>
        <div>{description || '-'}</div>
      </div>
      ...
      {!!calculatedFields.length && (
        <div className="mb-6" data-testid="metadata__calculated-fields">
          <Typography.Text className="d-block gray-7 mb-2">
            Trường tính toán ({calculatedFields.length})
          </Typography.Text>
