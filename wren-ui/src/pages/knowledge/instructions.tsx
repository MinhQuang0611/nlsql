  ...
  return (
    <SiderLayout loading={false}>
      <PageLayout
        ...
        description={
          <>
            Tại trang này, bạn có thể quản lý các hướng dẫn đã lưu để định hướng
            PTIT AI trong việc tạo truy vấn SQL. Các hướng dẫn này giúp PTIT AI
            hiểu mô hình dữ liệu và quy tắc nghiệp vụ của bạn, cải thiện độ
            chính xác của truy vấn và giảm nhu cầu chỉnh sửa thủ công.{' '}
            {/* <Link
